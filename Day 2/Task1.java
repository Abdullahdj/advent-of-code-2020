         ...
         for (int i = 0; i < input.length(); i++) {
             ...
             if (lowMode) {
                 if (passes == 0) { passes++; }
                     ...
                     if ((checkQuant <= highRange) && (checkQuant >= lowRange) && doneOnce) {
                         validPasses++;
                         doneOnce = true;
                     }
                 }
                 ...
                 if (c.equals("-")) { lowMode = false; highMode = true;
                 lowRange = Integer.parseInt(templowRange); templowRange = ""; }
                 else { templowRange += c; }
             }
             else if (highMode) {
                 if (c.equals(" ")) { highMode = false; passMode = true; doneOnce = true;
                 highRange = Integer.parseInt(temphighRange); temphighRange = "";}
                 else { temphighRange += c; }
             }
             else if (passMode) {
                 if (c.equals(":")) { passMode = false; checkMode = true; }
                 else  { charToCheck = c; }
             }
             else if (checkMode) {
                 if (c.equals("\n")) { checkMode = false; lowMode = true; }
                 else if (!(c.equals(" ")) && (c.equals(charToCheck))) { checkQuant++; }
             }
         }
